 ...
 * @author douwenjie
 */
public interface UsrPostMapper
{
    /**
     * 查询岗位数据集合
     * 
     ...
     * @return 结果
     */
    public List<UsrPost> selectPostsByUserName(String userName);
     ...
     * @return 结果
     */
    public UsrPost checkPostNameUnique(String postName);
     ...
     * @return 结果
     */
    public UsrPost checkPostCodeUnique(String postCode);
}
